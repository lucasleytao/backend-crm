        ...
        <div className="container-fluid titulo">
            ...
            <div className="row">
                <div className="col-4">
                    ...
                    <button onClick={(e) => clientesPdf(clientes)} className="btn btn-danger btn-pdf" type="button" id="button-addon2"><i className="fa-solid fa-file-pdf"></i> Gerar PDF</button>
                </div>
                <div className="col-7">
